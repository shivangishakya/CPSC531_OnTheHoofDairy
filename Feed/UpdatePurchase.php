...
input[type= submit]{ background-color: orange;
     ...
     ?>
       <tr>
         ...
         <td><?= $PurchaseID ?></td>
         <td><input type='date' name='Date_<?= $PurchaseID ?>' value='<?= $Date ?>' ></td>
         <td><input type='text' name='SupplierName_<?= $PurchaseID ?>' value='<?= $SupplierName ?>' ></td> 
         <td><?= $DeliveryCost ?></td>
         <td><?= $TotalCost ?></td>
       </tr>
     <?php
   ...
   <input type='submit' value='Update Item Purchase' name='ItemP' >&nbsp;&nbsp;
...
if(isset($_POST['update'])){
  ...
  foreach($_POST['update'] as $updateid){
    ...
    $updateUser = "UPDATE FeedPurchase SET 
                    Date='".$Date."',
...
if(isset($_POST['ItemP'])){
    header("Location: UpdateItemP.php");
