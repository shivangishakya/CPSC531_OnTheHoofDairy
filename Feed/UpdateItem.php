...
input[type= submit]{ background-color: orange;
     ...
     ?>
       <tr>
         ...
         <td><?= $ItemID ?></td>
         <td><input type='text' name='ItemName_<?= $ItemID ?>' value='<?= $ItemName ?>' ></td>
         <td><input type='number' name='Protein_<?= $ItemID ?>' value='<?= $Protein ?>' ></td> 
         <td><input type='number' name='Cost_<?= $ItemID ?>' value='<?= $Cost ?>' ></td>
       </tr>
     <?php
...
if(isset($_POST['update'])){
  foreach($_POST['update'] as $updateid){
    ...
    $updateUser = "UPDATE FeedItems SET 
                    ItemName='".$ItemName."',
                    Protein='".$Protein."',
                    Cost='".$Cost."'
