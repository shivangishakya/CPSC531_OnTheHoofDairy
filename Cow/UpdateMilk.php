...
input[type= submit]{ background-color: orange;
     ...
     ?>
       <tr>
         ...
         <td><?= $MID ?></td>
         <td><input type='number' name='CowID_<?= $MID ?>' value='<?= $CowID ?>' ></td>
         <td><input type='text' name='Date_<?= $MID ?>' value='<?= $Date ?>' ></td>
         <td><input type='number' name='Quantity_<?= $MID ?>' value='<?= $Quantity ?>' ></td> 
         <td><input type='text' name='Comments_<?= $MID ?>' value='<?= $Comments ?>' ></td>
       </tr>
     <?php
